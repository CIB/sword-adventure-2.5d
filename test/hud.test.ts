...
/** bar bodies: 1px-wide rects that stand on the plot's bottom row (y 72), excluding tips/dots/baseline */
const bars = () => ops.filter((o) => o.w === 1 && o.h > 1 && o.y + o.h - 1 === 72);
...
check('newest bar on the right edge', !!barAt(X0 + PLOT_W - 1));
...
check('50ms pegs the top', lastBar(50)?.y === 54, String(lastBar(50)?.y));
check('16.7ms sits on the 60fps line', lastBar(16.7)?.y === 66, String(lastBar(16.7)?.y));
