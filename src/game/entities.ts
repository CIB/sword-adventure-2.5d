...
import {
  ...
  GUST_HALF_ARC, gustRange, isLadybug, isSpitter, ENERGY_BALL_SPEED, SPITTER_MAW_H,
} from './models';
...
export class Enemy {
  ...
  update(dt: number) {
    ...
    if (this.rooted) { this.plantTick(dt, p, dx, dz, dist); this.animate(false); this.sync(); return; }
