...
export function buildHeroine(): Humanoid {
  ...
  head.add(part(UNIT_BOX, m.plate, [0, 0.05, 0.2], [0.6, 0.1, 0.22]));                // brow band, just above the eyes
  head.add(part(UNIT_BOX, m.hair, [-0.28, 0.0, 0.06], [0.08, 0.16, 0.24]));            // hair tufts out from under the helm rim at the sides
  head.add(part(UNIT_BOX, m.hair, [0.28, 0.0, 0.06], [0.08, 0.16, 0.24]));
  head.add(part(UNIT_BOX, m.hair, [0, 0.0, -0.26], [0.46, 0.2, 0.1]));                // and at the back
  ...
  ponytail.add(part(UNIT_BOX, m.hair, [0, -0.24, -0.06], [0.17, 0.4, 0.15]));
  ponytail.add(part(UNIT_SPHERE, m.hair, [0, -0.44, -0.06], [0.2, 0.16, 0.18]));
  head.add(ponytail);
